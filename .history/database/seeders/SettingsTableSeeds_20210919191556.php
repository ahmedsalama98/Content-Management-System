...
class SettingsTableSeeds extends Seeder
{
    ...
    public function run()
    {
        ...
        $data[]= ['display_name'=>'App Slogan','key'=>'app_slogan', 'value'=>'Amazing App','type'=>'text','section'=>'genral','ordering'=>2,];
        $data[]= ['display_name'=>'App Description','key'=>'app_description', 'value'=>'Content Management System','type'=>'text','section'=>'genral','ordering'=>3,];
