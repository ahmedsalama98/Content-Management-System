...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body" style="padding: 0">
            ...
            <div class="row" style="padding: 20px 2px">
                <div class="col-md-2">
                    ...
                    <form action="">
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel" aria-labelledby="v-pills-general-tab">.
                                ...
                                @forelse ($general as $general_item)
                                     ...
                                     <div class="row justify-content-center">
                                         <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $key =$general_item->key;
                                                    $value =$general_item->value;
                                                @endphp
                                                <label for="{{ $general_item->key}}">{{ $general_item->display_name }}</label>
                                                <input class="form-control" type="text" name="seetings[{{ $key}}]" id="{{ $key }}" value="{{  $value }}">
                                            </div>
                                         </div>
                                     </div>
                                @empty
