...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            <h4 class="m-0 font-weight-bold text-primary">Edit Admin
            </h4>
        </div>
        <div class="card-body"  >


            <form action="{{ route('admin.admins.update' , $admin->id) }}" method="POST" id="edit-admin-ajax">
                @csrf
                @method('PUT')
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-8">
                        <div class="form-group row align-items-center">
                            ...
                            <input value="{{ $admin->name }}" type="text" name="name" id="name" class="form-control field col-lg-10">
                        </div>
                ...
                <div class="row justify-content-center align-items-center ">
                    ...
                    <div class="col-lg-8">
                        <div class="form-group row align-items-center">
                            ...
                            <input value="{{ $admin->username }}" autocomplete="username" type="text" name="username" id="username" class="form-control field col-lg-10">
                        </div>
                ...
                <div class="row justify-content-center align-items-center ">
                    ...
                    <div class="col-lg-8">
                        <div class="form-group row align-items-center">
                            ...
                            <input value="{{ $admin->email }}" type="email" name="email" id="email" class="form-control field col-lg-10">
                        </div>
                ...
                <div class="row justify-content-center align-items-center ">
                    ...
                    <div class="col-lg-8">
                        <div class="form-group row align-items-center">
                            ...
                            <input type="number" value="{{ $admin->mobile }}" name="mobile" id="mobile" class="form-control field col-lg-10">
                        </div>
              ...
              {{-- //permissions --}}
                <div class="row justify-content-center align-items-center ">
                    ...
                    @php
                        $models =['admins','users','categories','pages','posts','comments'];
                                    ...
                                    <div class="tab-pane fade show {{ $index ==0 ?'active':'' }}" id="{{ $model }}" role="tabpanel" aria-labelledby="{{ $model }}-tab">
                                        ...
                                        @foreach ($crud as $action )
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9 ">
                                                    <input   {{ $admin->hasPermission($model.'-'.$action ) ? 'checked ':''}} class="form-check-input field" type="checkbox" value="{{ $model.'-'.$action }}" name="permissions[]" id="{{ $model.'-'.$action }}">
                                                </div>
                                            </div>
                                        @endforeach
